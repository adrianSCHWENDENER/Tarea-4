...
FINAL_IMAGE=${DISTDIR}/Tarea_4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Tarea_4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16HV540
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Tarea_4.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Tarea_4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16HV540 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Tarea_4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
